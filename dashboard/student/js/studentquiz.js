...
async function fetchQuizData(c_id) {
        try {
            const response = await fetch('https://learning-u7aw.onrender.com/api/quiz', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    try {
        const response = await fetch('https://learning-u7aw.onrender.com/api/quizinfo', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function displayResult() {
    ...
    try {
        ...
        const response = await fetch('https://learning-u7aw.onrender.com/api/performance', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function viewPerformance(user_id, q_id) {
    try {
        const response = await fetch('https://learning-u7aw.onrender.com/api/viewperformance', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
